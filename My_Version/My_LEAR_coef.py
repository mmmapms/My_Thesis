...
feat_keywords=[" Generation forecast (FR)", "System load forecast (FR) (MW)","Day-Ahead Generation forecast wind (BE) (MWh)","Day-ahead generation forecast Solar (BE) (MWh)","Grid load forecast (BE) (MW)", "all"]

exog_features=[" Generation forecast (FR)", "System load forecast (FR) (MW)","Day-Ahead Generation forecast wind (BE) (MWh)","Day-ahead generation forecast Solar (BE) (MWh)","Grid load forecast (BE) (MW)"]
lags=[1,2]
...
coef_hour.to_csv('C:/Users/mmmap/epftoolbox/My_Version/LEAR_Full_Dataset-NP_Coef.csv', index = False)
